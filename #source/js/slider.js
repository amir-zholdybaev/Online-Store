...
// var sliderImg = document.querySelector('#img-1 img');
// var sliderPrealoader = document.querySelector('.slider__preloader');

// sliderImg.onload = function preloadEnd() {
//   sliderPrealoader.classList.add('display-none2');
// };
    ...
    var multiItemSlider = (function () {
      ...
      return function (selector, config) {
        var
          ...
          _sliderWrapper = _mainElement.querySelector('.slider__row'),
        ...
        var _setUpListeners = function () {
          var _sliderWrapper = document.querySelector('.slider-wrapper');
